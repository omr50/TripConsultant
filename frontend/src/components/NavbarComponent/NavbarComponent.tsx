...
//         <Col xs={3}><img src={tripLogo} alt="Trip Advisor Logo" className="svg-home-logo" /></Col>
//         <Col xs={1} className="end"></Col>
//         <Col xs={2} className="end">
//         <div className="flex-container">
//             <svg viewBox="0 0 24 24" width="24px" height="24px" className="review-svg">
//               <path
//                 fillRule="evenodd"
//                 clipRule="evenodd"
...
//       <Row className='nav-row'>
//         <Col xs={3}>
//           <img src={tripLogo} alt="Trip Advisor Logo" className="svg-home-logo" />
//         </Col>
...
//           </div>
//           <div className="nav-item">
//             <Button className="signin-button end" onClick={() => { setSignup(!signup) }}>Sign in</Button>
//           </div>
//         </Col>
...
const NavigationBar = () => { 
  ...
  return (
    <div>
      {signup && <div style={overlayStyles} onClick={()=>{handleClose()}}/>}
      {signup && <LoginComponent closeForm={handleClose}/>}
      <Navbar collapseOnSelect expand="lg" bg="light" variant="light" className='nav-head'>
        <Container>
        <Navbar.Brand href="#home"><img src={tripLogo} alt="Trip Advisor Logo" className="svg-home-logo" /></Navbar.Brand>
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          ...
          <Nav.Link href="#features" className='nav-link-style'>              
            ...
            <Nav.Link>
              <Button className="signin-button-user-password end" onClick={() => { setSignup(!signup) }}>Sign in</Button>
            </Nav.Link>
          </Nav>
        </Navbar.Collapse>
        </Container>
